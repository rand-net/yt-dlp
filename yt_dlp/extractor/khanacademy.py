...
class KhanAcademyBaseIE(InfoExtractor):
    ...
    _PUBLISHED_CONTENT_VERSION = "e0e0829eddccf61666219fb40b0a260316161019"
...
class KhanAcademyUnitIE(KhanAcademyBaseIE):
    ...
    def _parse_component_props(self, component_props, display_id):
        ...
        selected_unit = (
            traverse_obj(course, ("unitChildren", lambda _, v: v["relativeUrl"] == f"/{display_id}", any)) or course
        )

        def build_entry(entry):
            return self.url_result(
                urljoin("https://www.khanacademy.org", entry["canonicalUrl"]),
                KhanAcademyIE,
                title=entry.get("translatedTitle"),
            )
        ...
        entries = traverse_obj(
            ...
            (
                ...
                ...,
                "curatedChildren",
                lambda _, v: v["contentKind"] == "Video" and v["canonicalUrl"],
                {build_entry},
            ),
        )
